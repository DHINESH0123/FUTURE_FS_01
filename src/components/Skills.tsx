          ...
          <div className="p-6 rounded-xl animated-card card-shadow">
            ...
            <div className="space-y-4 text-gray-600">
              <div className="pb-2 border-b border-gray-200">
                ...
                <p className="text-sm">Python, SQL, Java <span className="text-xs text-gray-600">(in progress)</span></p>
              </div>
              <div className="pb-2 border-b border-gray-200">
              ...
              <div className="pb-2 border-b border-gray-200">
                ...
                <p className="text-sm">Bootstrap, React <span className="text-xs text-gray-600">(in progress)</span></p>
              </div>
              <div>
